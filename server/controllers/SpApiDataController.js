...
const getSpApiData = asyncHandler(async (req, res) => {
    ...
    const Region = getSellerData.sellerAccount[getSellerData.sellerAccount.length - 1].region;
    const Country = getSellerData.sellerAccount[getSellerData.sellerAccount.length - 1].country;
