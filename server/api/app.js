...
const mcpSalesOnlyTestRoute=require('../routes/mcpSalesOnlyTest.routes.js')
...
const updateProductContentRoute=require('../routes/updateProductContent.routes.js')
const sixMonthUserMaintenanceTestRoute=require('../routes/sixMonthUserMaintenanceTest.routes.js')
const cogsRoute=require('../routes/cogs.routes.js')
const expensesRoute=require('../routes/expenses.routes.js')
...
const zohoRoute=require('../routes/zoho.routes.js')
const gmailRoute=require('../routes/gmail.routes.js')
...
app.use(helmet({
    ...
    contentSecurityPolicy: {
        ...
        directives: {
            ...
            scriptSrc: ["'self'", "'unsafe-inline'", "'unsafe-eval'", "https://www.googletagmanager.com", "https://static.hotjar.com", "https://connect.facebook.net", "https://analytics.ahrefs.com", "https://www.clarity.ms", "https://*.clarity.ms", "https://mediaassets-in.blr1.cdn.digitaloceanspaces.com", "https:"], // Allow inline scripts, eval, and external analytics
            scriptSrcElem: ["'self'", "'unsafe-inline'", "https://www.googletagmanager.com", "https://static.hotjar.com", "https://connect.facebook.net", "https://analytics.ahrefs.com", "https://www.clarity.ms", "https://*.clarity.ms", "https://mediaassets-in.blr1.cdn.digitaloceanspaces.com", "https:"], // Allow script elements (like dynamically loaded scripts)
            scriptSrcAttr: ["'unsafe-inline'"], // Allow inline event handlers (onclick, etc.)
            imgSrc: ["'self'", "data:", "https:"], // Allow images from any HTTPS source
            connectSrc: ["'self'", process.env.CORS_ORIGIN_DOMAIN, "https://www.google-analytics.com", "https://www.googletagmanager.com", "https://static.hotjar.com", "https://api.hotjar.com", "wss://ws.hotjar.com", "https://www.facebook.com", "https://*.clarity.ms", "https://mpc-prod-16-s6uit34pua-uk.a.run.app", "https://demo-1.conversionsapigateway.com", "https://www.google.com", "https://www.googleadservices.com", "https:", "wss:"].filter(Boolean), // Allow API connections and WebSockets from any HTTPS/WSS source
