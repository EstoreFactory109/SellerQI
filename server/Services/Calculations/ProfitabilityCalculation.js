 ...
 * @param {Array} totalSales - Array of sales data with asin, quantity, amount
 * @param {Array} productWiseSponsoredAds - Array of sponsored ads data with asin, spend
 * @param {Array} productWiseFBAData - Array of FBA data (legacy format)
 * @param {Array} FBAFeesData - Array of FBA fees data (new format)
 * @returns {Array} Array of profitability data by ASIN
 */
const Profitability = (totalSales, productWiseSponsoredAds, productWiseFBAData, FBAFeesData) => {
