                ...
                {displayedProducts.length > 0 ? (
                  displayedProducts.map((product, index) => {
                    ...
                    if (activeTab === 'optimization') {
                      ...
                      return (
                        <tr key={`opt-${product.asin}-${index}`} onClick={() => navigate(`/seller-central-checker-demo/${product.asin}`)} className="border-b border-[#30363d] hover:bg-[#21262d] cursor-pointer transition-colors">
                          ...
                          <td className="px-2 py-2 text-center align-top">
                            <button type="button" onClick={(e) => { e.stopPropagation(); navigate(`/seller-central-checker-demo/${product.asin}`); }} className="px-2 py-1 text-xs font-medium text-blue-400 hover:text-blue-300 bg-blue-500/10 hover:bg-blue-500/20 border border-blue-500/30 rounded transition-colors">View</button>
                          </td>
                        </tr>
                      );
                    }
