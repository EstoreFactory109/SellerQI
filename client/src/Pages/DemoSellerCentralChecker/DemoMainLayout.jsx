...
import DemoTopNav from './DemoTopNav.jsx';
import DemoLeftNavSection from './DemoLeftNavSection.jsx';
import DemoLeftNavSectionForTablet from './DemoLeftNavSectionForTablet.jsx';
import TrialBanner from '../../Components/TrialBanner/TrialBanner.jsx';
...
const DemoMainLayout = () => {
  ...
  return (
    <div className="flex min-h-screen w-full overflow-x-hidden bg-[#1a1a1a]">
      <DemoLeftNavSection />
      <DemoLeftNavSectionForTablet />
      <section className="flex-1 min-w-0 h-[100vh] flex flex-col overflow-x-hidden">
        <DemoTopNav />
        <TrialBanner />
        <div
          ref={scrollContainerRef}
          className={`flex-1 min-h-0 overflow-x-hidden scrollbar-hide ${
            location.pathname.includes('qmate') ? 'overflow-hidden flex flex-col' : 'overflow-y-auto'
          }`}
