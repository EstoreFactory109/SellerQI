...
const Dashboard = () => {
  ...
  useEffect(() => {
    ...
    if (location.pathname.includes('/dashboard') || location.pathname === '/seller-central-checker-demo/dashboard') {
  ...
  const quickStats = [
    { icon: Receipt, label: 'Amazon Owes You', value: reimbursementLoading ? 'Loading...' : formatCurrencyWithLocale(expectedReimbursement, currency), change: 'N/A', trend: 'neutral', color: 'emerald', link: '/seller-central-checker-demo/reimbursement-dashboard' },
    { icon: TrendingDown, label: 'Money Wasted in Ads', value: formatCurrencyWithLocale(amazonOwesYou, currency), change: 'N/A', trend: 'neutral', color: 'blue', link: '/seller-central-checker-demo/ppc-dashboard' },
    { icon: Gauge, label: 'ACoS %', value: `${acos}%`, change: 'N/A', trend: 'neutral', color: 'purple', link: '/seller-central-checker-demo/ppc-dashboard' },
    { icon: FileWarning, label: 'Total Issues', value: totalIssues.toLocaleString(), change: 'N/A', trend: 'neutral', color: 'orange', link: '/seller-central-checker-demo/issues' }
  ]
