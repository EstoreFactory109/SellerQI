...
const LeftNavSection = () => {
    ...
    // Demo: remove lock icons and show all nav items normally.
    ...
    const isIssuesPage = location.pathname === '/seller-central-checker-demo/issues';
    const isSettingsPage = location.pathname === '/seller-central-checker-demo/settings';
    const isPPCDashboardPage = location.pathname === '/seller-central-checker-demo/ppc-dashboard';
    const isKeywordAnalysisPage = location.pathname === '/seller-central-checker-demo/keyword-analysis';
    const isSponsoredAdsPage = isPPCDashboardPage || isKeywordAnalysisPage;
    const isIssuesSection = isIssuesPage || location.pathname === '/seller-central-checker-demo/issues-by-product';
    ...
    const handleSettingsClick = () => {
        if (!isSettingsPage) {
            ...
            navigate('/seller-central-checker-demo/settings?tab=profile');
        }
    ...
    const handleSponsoredAdsClick = () => {
        if (!isSponsoredAdsPage) {
            ...
            navigate('/seller-central-checker-demo/ppc-dashboard');
        }
    ...
    const logoutUser=async(e)=>{
        ...
        setLoader(true)
        try {
            await axios.get(`${import.meta.env.VITE_BASE_URI}/app/demo/logout`, {withCredentials:true});
            dispatch(logout());
        ...
        <aside className="h-screen w-[240px] xl:w-[280px] flex-shrink-0 border-r border-[#30363d] font-roboto bg-[#161b22] hidden lg:flex lg:flex-col overflow-hidden">
            ...
            <div className="flex flex-col justify-between h-full min-h-0">
                ...
                <div className="flex flex-col flex-1 min-h-0 overflow-hidden">
                    ...
                    <div className="space-y-0.5">
                        ...
                        {(!isLiteUser || isPremiumLocked) && (
                            <NavLink
                                to="/seller-central-checker-demo/dashboard"
                                className={({ isActive }) =>
                        ...
                        {(!isLiteUser || isPremiumLocked) && (
                            <NavLink
                                to="/seller-central-checker-demo/qmate"
                                className={({ isActive }) =>
                                    `${menuItemClass} ${isActive ? activeMenuItemClass : inactiveMenuItemClass}`
                                }
                            >
                        ...
                        {(!isLiteUser || isPremiumLocked) && (
                            <NavLink
                                to="/seller-central-checker-demo/your-products"
                                className={({ isActive }) =>
                                    `${menuItemClass} ${isActive ? activeMenuItemClass : inactiveMenuItemClass}`
                                }
                            >
                        ...
                        <NavLink
                            to="/seller-central-checker-demo/pre-analysis"
                            className={({ isActive }) =>
                                `${menuItemClass} ${isActive ? activeMenuItemClass : inactiveMenuItemClass}`
                            }
                        >
                        ...
                        {(!isLiteUser || isPremiumLocked) && (
                            <NavLink
                                to="/seller-central-checker-demo/issues?tab=account"
                                className={({ isActive }) =>
                                    `${menuItemClass} ${
                            ...
                            <AnimatePresence>
                                {sponsoredAdsDropdownOpen && (
                                    ...
                                    >
                                        ...
                                        >
                                            <NavLink
                                                to="/seller-central-checker-demo/ppc-dashboard"
                                                className={({ isActive }) =>
                                                    `${dropdownItemClass} ${
                                                        isActive
                                        ...
                                        >
                                            <NavLink
                                                to="/seller-central-checker-demo/keyword-analysis"
                                                className={({ isActive }) =>
                                                    `${dropdownItemClass} ${
                                                        isActive
                                                            ? 'bg-gradient-to-r from-blue-500 to-blue-600 text-white shadow-md shadow-blue-500/25'
                        ...
                        {(!isLiteUser || isPremiumLocked) && (
                            <NavLink
                                to="/seller-central-checker-demo/profitibility-dashboard"
                                className={({ isActive }) =>
                                    `${menuItemClass} ${isActive ? activeMenuItemClass : inactiveMenuItemClass}`
                                }
                            >
                        ...
                        {(!isLiteUser || isPremiumLocked) && (
                            <NavLink
                                to="/seller-central-checker-demo/reimbursement-dashboard"
                                className={({ isActive }) =>
                                    `${menuItemClass} ${isActive ? activeMenuItemClass : inactiveMenuItemClass}`
                                }
                            >
                        ...
                        {SHOW_RECENT_ORDERS_NAV && (!isLiteUser || isPremiumLocked) && (
                            <NavLink
                                to="/seller-central-checker-demo/review-request"
                                className={({ isActive }) =>
                                    `${menuItemClass} ${isActive ? activeMenuItemClass : inactiveMenuItemClass}`
                                }
                            >
                        ...
                        {(!isLiteUser || isPremiumLocked) && (
                            <NavLink
                                to="/seller-central-checker-demo/tasks"
                                className={({ isActive }) =>
                                    `${menuItemClass} ${isActive ? activeMenuItemClass : inactiveMenuItemClass}`
                                }
                            >
                        ...
                        {false && (
                            <NavLink
                                to="/seller-central-checker-demo/ecommerce-calendar"
                                className={({ isActive }) =>
                                    `${menuItemClass} ${isActive ? activeMenuItemClass : inactiveMenuItemClass}`
                                }
                            >
                        ...
                        {(!isLiteUser || isPremiumLocked) && (
                            <NavLink
                                to="/seller-central-checker-demo/account-history"
                                className={({ isActive }) =>
                                    `${menuItemClass} ${isActive ? activeMenuItemClass : inactiveMenuItemClass}`
                                }
                            >
                        ...
                        {isSuperAdmin && (
                            <NavLink
                                to="/seller-central-checker-demo/user-logging"
                                className={({ isActive }) =>
                ...
                <div className="px-2 py-2">
                            ...
                            <AnimatePresence>
                                {settingsDropdownOpen && (
                                    ...
                                    >
                                        ...
                                        >
                                            <NavLink
                                                to="/seller-central-checker-demo/settings?tab=profile"
                                                className={() =>
                                                    `${dropdownItemClass} ${
                                        ...
                                        {!isLiteUser && !isAgencyUser && (
                                            ...
                                            >
                                                <NavLink
                                                    to="/seller-central-checker-demo/settings?tab=account-integration"
                                                    className={() =>
                                                        `${dropdownItemClass} ${
                                        ...
                                        {!isAgencyUser && (
                                            ...
                                            >
                                                <NavLink
                                                    to="/seller-central-checker-demo/settings?tab=support"
                                                    className={() =>
                                                        `${dropdownItemClass} ${
                                        ...
                                        >
                                            <NavLink
                                                to="/seller-central-checker-demo/settings?tab=plans-billing"
                                                className={() =>
                                                    `${dropdownItemClass} ${
                                        ...
                                        {isAgencyUser && (
                                            <>
                                                ...
                                                >
                                                    <NavLink
                                                        to="/seller-central-checker-demo/settings?tab=admin-user-profile"
                                                        className={() =>
                                                            `${dropdownItemClass} ${
                                                ...
                                                >
                                                    <NavLink
                                                        to="/seller-central-checker-demo/settings?tab=admin-account-integration"
                                                        className={() =>
                                                            `${dropdownItemClass} ${
                                                ...
                                                >
                                                    <NavLink
                                                        to="/seller-central-checker-demo/settings?tab=admin-plans-billing"
                                                        className={() =>
                                                            `${dropdownItemClass} ${
                                                ...
                                                >
                                                    <NavLink
                                                        to="/seller-central-checker-demo/settings?tab=admin-support"
                                                        className={() =>
                                                            `${dropdownItemClass} ${
                    ...
                    <div className="mb-2">
                        <NavLink
                            to="/seller-central-checker-demo/consultation"
