    ...
    const conversionTableRows = useMemo(() => {
        ...
        const pushRow = (heading, subheading, errorObj) => {
            ...
            rows.push({
                ...
                // Demo mock uses `HowTOSolve` (capital T) - keep consistent so UI shows the solution.
        ...
        if (errors.inventoryPlanningErrorData) {
            ...
            if (planning.longTermStorageFees?.status === 'Error') {
                rows.push({
                    ...
                    // Planning errors come from `mkError` in the demo mock which uses `HowTOSolve`
                                                ...
                                                {(info?.productWiseError || []).map((item, index) => (
                                                    <button
                                                        ...
                                                        onMouseDown={(e) => {
                                                            ...
                                                            navigate(`/seller-central-checker-demo/${item.asin}`);
                                                            setOpenSelector(false);
                                                        }}
                                                    >
