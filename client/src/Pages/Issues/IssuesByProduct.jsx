...
const RankingIssuesTable = ({ product }) => {
                ...
                Object.keys(issueLabels).forEach((checkKey) => {
                    ...
                    if (check?.status === 'Error') {
                        const attributeKey =
                            ...
                            sectionKey === 'Description' ? 'description' :
                            'backend';
                        errorRows.push({
    ...
    const hasTitleIssue = errors.some(e => e.attributeKey === 'title');
    const hasDescriptionIssue = errors.some(e => e.attributeKey === 'description');
    const hasBulletpointsIssue = errors.some(e => e.attributeKey === 'bulletpoints');
    const hasBackendIssue = errors.some(e => e.attributeKey === 'backend');
    const firstBackendError = errors.find(e => e.attributeKey === 'backend');
