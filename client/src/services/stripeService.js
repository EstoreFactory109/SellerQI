...
class StripeService {
     ...
     * @param {string} [currency] - Optional currency hint ('inr' for Indian pricing)
     */
    async createCheckoutSession(planType, couponCode = null, trialPeriodDays = null, currency = null) {
        try {
