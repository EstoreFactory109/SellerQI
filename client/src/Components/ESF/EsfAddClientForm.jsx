 ...
 * Creates the client, then hands it back so the parent can start Amazon setup.
 */
const EsfAddClientForm = ({ onCancel, onCreated, showCancelButton = false }) => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const res = await axiosInstance.post('/app/esf/clients', {
        ...formData,
...
export default EsfAddClientForm;
