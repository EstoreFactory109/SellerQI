 ...
 */
export async function createVendorAnalyticsQuery(query) {
    const body = { query };
 ...
 */
export function buildVendorAnalyticsQuery(viewType, startDate, endDate, aggregateBy, metricGroups, groupByAttributes) {
    ...
    const buildMetricStructure = (group) => {
        switch (group) {
            case "shippedOrders":
                return `
