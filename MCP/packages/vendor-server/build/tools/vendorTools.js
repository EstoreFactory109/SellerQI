...
export function registerVendorTools(server) {
    ...
    server.tool("explore-vendor-analytics-schema", "Explore the Vendor Analytics GraphQL schema structure to help build queries", {
        entityType: z.enum([
            "overview",
            "sourcingView",
            "manufacturingView",
...
- You can combine multiple attributes to create more detailed segments`;
    ...
    server.tool("build-vendor-analytics-query", "Build a GraphQL query for vendor analytics based on parameters", {
        ...
        try {
            const query = buildVendorAnalyticsQuery(params.viewType, params.startDate, params.endDate, params.aggregateBy, params.metricGroups, params.groupByAttributes);
            return {
                content: [
                    {
                        type: "text",
    ...
    server.tool("get-vendor-analytics-example", "Get example GraphQL queries for vendor analytics", {
        queryType: z.enum([
