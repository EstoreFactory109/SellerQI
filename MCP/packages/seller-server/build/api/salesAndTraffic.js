 ...
 */
export async function createSalesAndTrafficQuery(query) {
    const body = { query };
 ...
 */
export function buildSalesAndTrafficQuery(aggregationType, startDate, endDate, granularity, marketplaceIds, includeB2B = false) {
