...
export function registerSalesTools(server) {
    ...
    server.tool("explore-sales-and-traffic-schema", "Explore the Sales and Traffic GraphQL schema structure to help build queries", {
        entityType: z.enum([
            "overview",
            "byDate",
            "byAsin",
...
- \`unitSessionPercentageB2B\`: B2B conversion rate`;
    ...
    server.tool("build-sales-and-traffic-query", "Build a GraphQL query for sales and traffic based on parameters", {
        ...
        try {
            ...
            const query = buildSalesAndTrafficQuery(params.aggregationType, params.startDate, params.endDate, params.granularity, // Type casting to satisfy TypeScript
            [marketplaceId], params.includeB2B);
            return {
                content: [
                    {
                        type: "text",
    ...
    server.tool("get-sales-and-traffic-example", "Get example GraphQL queries for sales and traffic data", {
        queryType: z.enum([
            "salesByDate",
            "salesByAsin",
